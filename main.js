! function(e) {
  ...
  AFRAME.registerComponent("shooter", {
    ...
    init: function() {
      ...
      entityEl.setAttribute("id", "life")
      entityEl.setAttribute("value", "Life : 2")
      ...
      e.appendChild(entityEl)
    },
    update: function(e) {
      this.healthPoints = this.data.healthPoints
    },
    onBulletHit: function(e) {
      let tt = `Life : ${this.healthPoints-1}`
      console.log(tt);
      this.el.children[1].setAttribute("value", tt)
